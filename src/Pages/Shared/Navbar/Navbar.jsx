    ...
    <div className="">
      <div className="navbar ">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              ...
              } rounded-box mt-3 w-52 p-2 shadow z-50 text-white`}
            >
              {/* Links */}
              {links}
            </ul>
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu-horizontal px-1 space-x-10 text-white">
            {/* Links */}
            {links}
          </ul>
        </div>
        {user ? (
          ...
          <div className="navbar-end space-x-2">
            ...
            <Link to="/register">
              <button className="bg-blue-500 py-1.5 px-2 md:py-2 md:px-5 rounded-md text-white font-semibold text-xs">
                Sign Up
              </button>
            </Link>
            <Link to="/login">
